...
1. Create a new directory under your Ren'Py directory.
2. Unpack this zip file into that new directory.
3. Enjoy!
...
The "project" zip is not suitable for updating.  If you started your project
from the "project" zip, updating should be done with the "slim" zip instead.
