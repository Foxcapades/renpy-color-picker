...
define config.name = _("lib-color-picker")
...
define config.version = "1.1.1-rc1"
...
define build.name = "lib-color-picker"
...
define config.save_directory = "libcolorpicker-1691453030"
